...
export const serviceKeywords: Record<string, KeywordMapping> = {
  ...
  'mattress-removal': {
    ...
    expertTerms: ['mattress disposal', 'bedding removal', 'sleep system disposal'],
    noviceTerms: [
      'old mattress pickup',
      'bed removal',
      'mattress haul away',
  ...
  'hot-tub-removal': {
    ...
    expertTerms: ['spa removal', 'jacuzzi removal', 'hydrotherapy unit removal'],
    noviceTerms: [
      'hot tub disposal',
      'hot tub haul away',
      'get rid of hot tub',
    ...
    actionTerms: ['remove hot tub', 'dispose of spa', 'haul away jacuzzi', 'get hot tub picked up'],
    localVariations: [
  ...
  'appliance-removal': {
    ...
    expertTerms: ['white goods removal', 'major appliance disposal', 'kitchen appliance removal'],
    noviceTerms: [
  ...
  'estate-cleanouts': {
    ...
    expertTerms: ['estate liquidation cleanup', 'probate property cleanup', 'estate sale cleanup'],
    noviceTerms: [
      'house cleanout',
      'property cleanout',
  ...
  'garage-cleanout': {
    ...
    expertTerms: ['garage organization', 'garage clearing service'],
    noviceTerms: [
      'garage cleanup',
      'clean out garage',
      'garage junk removal',
  ...
  'yard-waste-removal': {
    ...
    expertTerms: ['landscape debris removal', 'organic waste disposal', 'green waste pickup'],
    noviceTerms: [
      'yard cleanup',
      'brush removal',
      'tree debris removal',
  ...
  'shed-removal': {
    ...
    expertTerms: ['outbuilding removal', 'structure demolition'],
    noviceTerms: [
      'shed disposal',
      'old shed removal',
      'shed haul away',
