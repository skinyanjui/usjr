...
export const metadata: Metadata = {
  title: 'Get Your Free Quote | Uncle Sam Junk Removal - Junk Removal & Cleaning',
  description:
  ...
  keywords:
    'free quote Evansville, junk removal quote, cleaning quote, light demolition quote, Uncle Sam Junk Removal pricing',
  robots: 'index, follow',
              ...
              <CardContent className="p-6 sm:p-8">
                <div className="mb-6 text-center">
                  <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-orange-100 sm:h-16 sm:w-16">
                    <Hammer className="h-6 w-6 text-orange-600 sm:h-8 sm:w-8" />
                  </div>
                  <h2 className="mb-2 text-xl font-bold text-gray-900 sm:text-2xl">
                    Light Demolition
                  </h2>
                  <p className="text-gray-600">Safe tear-down and debris removal for small structures</p>
                </div>

                <div className="mb-6 space-y-4">
                  <div className="rounded-lg bg-orange-50 p-4">
                    <h3 className="mb-2 font-semibold text-orange-900">Typical Project Pricing:</h3>
                    <ul className="space-y-1 text-sm text-orange-800">
                      <li>• Shed removal: From $349-$549</li>
                      <li>• Deck removal: From $399-$699</li>
                      <li>• Hot tub removal: From $399-$699</li>
                      <li>• Interior demo: Custom quote</li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      Full tear-down and debris hauling
                    </div>
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      Safe, insured crew
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      <CheckCircle className="h-4 w-4 text-green-600" />
                      Cleanup and site sweep included
                    </div>
                  </div>
                </div>
