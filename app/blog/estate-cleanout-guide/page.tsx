...
export const metadata: Metadata = {
  ...
  keywords: "estate cleanout, estate planning, donation options Evansville, family estate cleanup, compassionate cleanout service, probate cleanout",
        ...
        <GlassCard className="p-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mb-8">
              <h3 className="text-lg font-semibold text-blue-800 mb-2">Our Promise to Families</h3>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-6">Phase 1: Emotional and Legal Preparation (Week 1-2)</h2>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-4">Give Yourself Time to Grieve</h3>
            <p className="mb-4">
            ...
            <div className="bg-yellow-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-yellow-800 mb-2">Essential First Steps:</h4>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-4">Understanding Legal Requirements</h3>
            <p className="mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-6">Phase 2: Family Communication and Planning (Week 2-4)</h2>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-4">The Family Meeting Approach</h3>
            <p className="mb-4">
            ...
            <div className="bg-green-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-green-800 mb-2">Recommended Family Meeting Agenda:</h4>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-4">Creating a Systematic Approach</h3>
            <p className="mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-gray-50 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-800 mb-2">Start with These Areas:</h4>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h4 className="font-semibold text-gray-800 mb-2">Save for Later:</h4>
                <ul className="list-disc pl-6 text-gray-700 space-y-1">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-6">Phase 3: Sorting and Decision Making</h2>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-4">The Five-Category System</h3>
            <p className="mb-4">
            ...
            <div className="space-y-4 mb-6">
              <div className="border-l-4 border-blue-400 pl-4">
                ...
                <p className="text-gray-700">Items with sentimental value or practical use for family members</p>
              </div>
              <div className="border-l-4 border-green-400 pl-4">
                <h4 className="font-semibold text-green-800">2. Donate (Good Condition)</h4>
                <p className="text-gray-700">Usable items that can benefit others in the community</p>
              </div>
              ...
              <div className="border-l-4 border-orange-400 pl-4">
                ...
                <p className="text-gray-700">Materials that can be recycled rather than thrown away</p>
              </div>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-6">Local Southern Indiana Donation and Recycling Options</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-blue-800 mb-4">Furniture & Household Items</h3>
                <ul className="space-y-3">
                  <li>
                    <strong>Habitat for Humanity ReStore</strong><br/>
                    <span className="text-sm text-blue-700">2828 Washington Ave, Evansville<br/>Furniture, appliances, building materials</span>
                  </li>
                  <li>
                    <strong>Goodwill Industries</strong><br/>
                    <span className="text-sm text-blue-700">Multiple locations<br/>Clothing, household items, electronics</span>
                  </li>
                  <li>
                    <strong>Catholic Charities</strong><br/>
                    <span className="text-sm text-blue-700">Furniture bank for families in need</span>
                  </li>
                </ul>
              </div>
              <div className="bg-green-50 p-6 rounded-lg">
                <h3 className="text-lg font-semibold text-green-800 mb-4">Specialized Items</h3>
                <ul className="space-y-3">
                  <li>
                    <strong>Books & Media</strong><br/>
                    <span className="text-sm text-green-700">Evansville Library, local schools</span>
                  </li>
                  <li>
                    <strong>Medical Equipment</strong><br/>
                    <span className="text-sm text-green-700">Area churches, senior centers</span>
                  </li>
                  <li>
                    <strong>Art & Collectibles</strong><br/>
                    <span className="text-sm text-green-700">Local museums, schools, community centers</span>
                  </li>
                </ul>
              </div>
            </div>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-6">When to Call Professionals</h2>
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-6 mb-8">
              <h3 className="text-lg font-semibold text-red-800 mb-2">Our Estate Cleanout Process</h3>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-6">Handling Emotional Challenges</h2>
            ...
            <div className="bg-purple-50 p-6 rounded-lg mb-6">
              <h4 className="font-semibold text-purple-800 mb-2">Common Emotional Triggers:</h4>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-4">Practical Emotional Support Strategies:</h3>
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li><strong>Take breaks:</strong> Don't try to complete everything in one weekend</li>
              <li><strong>Bring support:</strong> Have friends or family members present for emotional support</li>
              <li><strong>Honor memories:</strong> Create a memory box or photo album of special items</li>
              <li><strong>Share stories:</strong> Talk about memories associated with items as you sort</li>
              <li><strong>Consider timing:</strong> Avoid anniversaries or emotionally difficult dates</li>
              <li><strong>Practice self-care:</strong> Plan pleasant activities between sorting sessions</li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-6">Final Thoughts: Honoring a Life Well-Lived</h2>
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">How We Can Help</h3>
