...
const serviceInfo = {
  ...
  price: "From $299-1299",
  benefits: ["Commercial equipment handling", "Licensed & insured", "Disconnect coordination", "Scrap metal recycling"]
}
...
export default function RestaurantEquipmentRemovalPage() {
  return (
    <ServicePageTemplate
      ...
      features={[
        {
          ...
          description: "Expert removal of ovens, fryers, grills, and all commercial cooking equipment",
        },
        {
          icon: Refrigerator,
      ...
      pricing={[
        { name: "Single Equipment Item", price: "From $299-499", description: "Individual ovens, refrigerators" },
        { name: "Kitchen Section", price: "From $499-899", description: "Partial kitchen removal" },
        { name: "Complete Restaurant", price: "From $899-1299", description: "Full restaurant cleanout" },
      ]}
      steps={[
        {
          icon: ChefHat,
      ...
      faqs={[
        {
          ...
          answer: "We coordinate with licensed professionals for gas line disconnections. We don't perform utility disconnections ourselves but can arrange for qualified technicians as part of the service."
        },
        {
          question: "Can you remove walk-in coolers?",
          answer: "Yes, we specialize in walk-in cooler and freezer removal. These require specialized equipment and coordination with refrigeration technicians for proper coolant handling."
        },
        {
          question: "What happens to the scrap metal?",
          answer: "Commercial kitchen equipment contains valuable metals. We recycle all metal components and can often provide credit toward your service cost based on current scrap metal prices."
        },
        {
          question: "Do you work with restaurant closures?",
          answer: "Absolutely. We frequently work with restaurant owners, landlords, and property managers during restaurant closures, renovations, and equipment updates."
        }
      ]}
    ...
    >
      <div className="prose max-w-none">
        ...
        <p>
          Restaurant equipment removal requires specialized knowledge and equipment. Our team understands the 
          unique challenges of commercial kitchen equipment including size, weight, utility connections, and 
          proper disposal methods.
        </p>
        
        <h3>Equipment We Regularly Remove</h3>
        <ul>
          <li><strong>Cooking Equipment:</strong> Commercial ovens, ranges, fryers, grills, steamers</li>
          <li><strong>Refrigeration:</strong> Walk-in coolers, reach-in units, freezers, ice machines</li>
          <li><strong>Prep Equipment:</strong> Commercial sinks, prep tables, dishwashers, mixers</li>
          <li><strong>Ventilation:</strong> Hood systems, exhaust fans, ductwork (coordination)</li>
        </ul>

        <h3>Restaurant Closure Services</h3>
        <p>
          We understand the challenges of restaurant closures and work efficiently to help owners and 
          landlords clear spaces quickly for the next tenant or renovation project.
        </p>
      </div>
    </ServicePageTemplate>
  )
