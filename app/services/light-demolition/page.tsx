...
const serviceInfo = {
  ...
  price: "From $389-899",
  benefits: ["Same-day service", "OSHA safety compliant", "Selective demolition", "Complete cleanup"]
}
...
export default function LightDemolitionPage() {
  ...
  return (
    <ServicePageTemplate
      ...
      badges={[UNIFORM_OFFERS.SAME_DAY_SERVICE, "OSHA safety compliant", UNIFORM_OFFERS.LICENSED_INSURED]}
      ...
      pricing={[
        { name: "Interior Room Demo", price: "From $389-549", description: "Perfect for bathroom/kitchen renovations" },
        { name: "Deck Removal", price: "From $289-649", description: "Complete deck demolition and removal" },
        { name: "Fence Removal", price: "From $289-489", description: "Fence and gate removal service" },
        { name: "Kitchen/Bath Demo", price: "From $549-899", description: "Complete fixture and cabinet removal" },
        { name: "Flooring Removal", price: "From $3-8/sq ft", description: "All flooring types and disposal" },
      ]}
      faqs={[
        {
          question: `Do you provide ${UNIFORM_OFFERS.SAME_DAY_SERVICE.toLowerCase()} for light demolition?`,
          answer:
            `Yes! We offer ${UNIFORM_OFFERS.SAME_DAY_SERVICE.toLowerCase()} assessment and can often begin demolition projects the same day, subject to availability and project complexity.`,
        },
        {
        ...
        },
        {
          ...
          answer:
            `${PRICING_LANGUAGE.PRICING_NOTES.VOLUME_BASED}. ${PRICING_LANGUAGE.PRICING_NOTES.INCLUDES_LABOR}. All prices include demolition, debris removal, and site cleanup. ${PRICING_LANGUAGE.PRICING_NOTES.NO_SURPRISE_FEES}.`,
        },
        {
