...
export default function YardWasteRemovalPage() {
  ...
  const relatedContent = [
    {
      ...
      description: "Complete guide to yard waste disposal in Evansville. Learn about composting and local facilities.",
      type: "blog" as const,
  ...
  return (
    <ServicePageTemplate
      ...
      pricing={[
        { name: "Small Load", price: "From $179-289", description: PRICING_LANGUAGE.TIER_DESCRIPTORS.SINGLE_ITEM },
        { name: "Medium Load", price: "From $289-389", description: PRICING_LANGUAGE.TIER_DESCRIPTORS.QUARTER_LOAD },
        { name: "Large Load", price: "From $389-489", description: PRICING_LANGUAGE.TIER_DESCRIPTORS.HALF_LOAD },
      ]}
      faqs={[
        {
