...
const serviceInfo = {
  ...
  price: "From $49-149",
  benefits: ["Same-day service", "Christmas tree removal", "Eco-friendly disposal", "Seasonal scheduling"]
}
...
export default function HolidayTreeRemovalPage() {
  return (
    <ServicePageTemplate
      ...
      pricing={[
        { name: "Single Christmas Tree", price: "From $49-79", description: "Standard size Christmas trees" },
        { name: "Large Tree + Cleanup", price: "From $79-119", description: "Large trees with needle cleanup" },
        { name: "Multiple Trees/Seasonal", price: "From $119-149", description: "Multiple trees or seasonal cleanup" },
      ]}
      steps={[
        {
          icon: Calendar,
      ...
      faqs={[
        {
          ...
          answer: "We're busiest the week after Christmas through mid-January. For best availability, schedule your tree removal before January 2nd or be flexible with scheduling during peak season."
        },
        {
          question: "Do you clean up the needles?",
          answer: "Yes, our standard tree removal includes cleaning up fallen needles around the tree area. We bring the necessary equipment to ensure your home is left clean."
        },
        {
          question: "What happens to the Christmas trees?",
          answer: "All trees are recycled responsibly. They're typically chipped for mulch or composted. We never send Christmas trees to landfills - they're 100% biodegradable and recyclable."
        },
        {
          question: "Can you remove trees from upper floors?",
          answer: "Yes, we can safely remove trees from second floors, apartments, and condos. Our team has experience navigating stairs and tight spaces."
        }
      ]}
    ...
    >
      <div className="prose max-w-none">
        ...
        <p>
          Nobody wants to deal with removing a dried-out Christmas tree after the holidays. Our holiday tree 
          removal service makes post-Christmas cleanup easy and convenient, so you can focus on getting back 
          to your regular routine.
        </p>
        
        <h3>Our Holiday Services Include</h3>
        <ul>
          <li><strong>Christmas Tree Removal:</strong> Safe removal of trees from any location in your home</li>
          <li><strong>Needle Cleanup:</strong> Complete cleanup of fallen needles and debris</li>
          <li><strong>Seasonal Landscaping:</strong> Winter cleanup and seasonal yard preparation</li>
          <li><strong>Multiple Tree Service:</strong> Discounts for multiple trees or annual service</li>
        </ul>

        <h3>Peak Season Scheduling</h3>
        <p>
          Our holiday tree removal service is especially popular during Christmas season and landscaping 
          seasons. We recommend scheduling early for best availability during peak times.
        </p>
      </div>
    </ServicePageTemplate>
  )
