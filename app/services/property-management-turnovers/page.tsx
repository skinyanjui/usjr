...
const serviceInfo = {
  ...
  price: "From $199-799",
  benefits: ["Same-day service", "Property management coordination", "Complete unit clearing", "Fast turnaround"]
}
  ...
  return (
    <ServicePageTemplate
      ...
      pricing={[
        ...
        { name: "2-3BR Apartment/Home", price: "From $399-599", description: "Standard rental properties" },
        { name: "Large Home/Complex", price: "From $599-799", description: "Large properties and houses" },
      ]}
      steps={[
        {
          icon: Key,
      ...
      faqs={[
        {
          ...
          answer: "Yes, we provide special pricing for property management companies and landlords with multiple properties or regular cleanout needs. Contact us for volume pricing."
        },
        {
          question: "How quickly can you clear a unit?",
          answer: "Most units can be cleared within 4-8 hours depending on size and contents. We understand the importance of minimizing vacancy time and offer same-day service when possible."
        },
        {
          question: "Can you handle eviction cleanouts?",
          answer: "Yes, we frequently work with property managers and court officers for eviction cleanouts. We understand the legal requirements and handle these situations professionally and sensitively."
        },
        {
          question: "What about abandoned property laws?",
          answer: "We work with property managers to ensure compliance with local abandoned property laws. We can hold items for the required period or coordinate proper disposal according to legal requirements."
        }
      ]}
    ...
    >
      <div className="prose max-w-none">
        ...
        <p>
          Property managers need reliable, fast cleanout services to minimize vacancy time and prepare units 
          for new tenants. We specialize in apartment turnovers, eviction cleanouts, and foreclosure situations 
          with professional, efficient service.
        </p>
        
        <h3>Types of Property Turnovers We Handle</h3>
        <ul>
          <li><strong>Standard Turnovers:</strong> Normal tenant move-out cleanouts and preparation</li>
          <li><strong>Eviction Cleanouts:</strong> Court-ordered eviction property clearing</li>
          <li><strong>Foreclosure Properties:</strong> Bank-owned property cleanouts</li>
          <li><strong>Abandoned Properties:</strong> Long-vacant property clearing and preparation</li>
        </ul>

        <h3>Why Property Managers Choose Us</h3>
        <p>
          We understand the rental property business and work efficiently to get units rent-ready quickly. 
          Our property management partnerships help minimize costs and maximize rental income potential.
        </p>
      </div>
    </ServicePageTemplate>
  )
