...
const serviceInfo = {
  ...
  price: "From $199-899",
  benefits: ["Same-day service", "Licensed & insured", "IT equipment handling", "Document disposal"]
}
...
export default function OfficeCleanoutsPage() {
  return (
    <ServicePageTemplate
      ...
      pricing={[
        { name: "Small Office (1-5 desks)", price: "From $199-399", description: "Small offices and suites" },
        { name: "Medium Office (6-20 desks)", price: "From $399-699", description: "Mid-size office spaces" },
        { name: "Large Office (20+ desks)", price: "From $699-899", description: "Large office complexes" },
      ]}
      steps={[
        {
          icon: Building,
      ...
      faqs={[
        {
          ...
          answer: "Yes, we have experience with IT equipment removal including computers, servers, and networking equipment. We can coordinate with your IT department for data security and proper equipment handling."
        },
        {
          question: "Do you provide secure document destruction?",
          answer: "We can coordinate secure document disposal services. For highly sensitive documents, we recommend working with certified document destruction services, which we can help arrange."
        },
        {
          question: "Can you work outside business hours?",
          answer: "Absolutely. We understand business operations can't be interrupted. We frequently work evenings, weekends, and holidays to accommodate office cleanouts without disrupting business."
        },
        {
          question: "What happens to office furniture?",
          answer: "We work to donate usable office furniture to local non-profits, schools, and charities. Items that can't be donated are recycled or disposed of responsibly."
        }
      ]}
    ...
    >
      <div className="prose max-w-none">
        ...
        <p>
          Office relocations, downsizing, and building management require specialized cleanout services. Our team 
          understands the unique challenges of office environments including IT equipment, sensitive documents, 
          and coordination with building management.
        </p>
        
        <h3>What We Remove from Offices</h3>
        <ul>
          <li><strong>Furniture:</strong> Cubicles, desks, chairs, conference tables, filing cabinets</li>
          <li><strong>IT Equipment:</strong> Computers, monitors, printers, servers, networking equipment</li>
          <li><strong>Office Supplies:</strong> Paper, binders, supplies, and general office materials</li>
          <li><strong>Storage:</strong> File cabinets, storage units, and document archives</li>
        </ul>

        <h3>Perfect for Building Managers</h3>
        <p>
          We work closely with building managers and property management companies to ensure smooth tenant 
          turnovers and building preparation for new tenants.
        </p>
      </div>
    </ServicePageTemplate>
  )
