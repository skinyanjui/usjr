    ...
    <>
      ...
      <section className="bg-muted/30 py-12">
        <div className="container mx-auto max-w-4xl px-4">
          <h2 className="mb-2 text-center text-2xl font-bold">Helpful Guides for Boonville Residents</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            >
              ...
              <p className="text-muted-foreground text-xs">Expert tips for efficient junk removal serving Boonville and Warrick County.</p>
            </a>
            <a
            ...
            >
              ...
              <p className="text-muted-foreground text-xs">Step-by-step guide to planning an estate cleanout with donation options.</p>
            </a>
            <a
            ...
            >
              ...
              <p className="text-muted-foreground text-xs">Full pricing guide for junk removal in Boonville and surrounding areas.</p>
            </a>
          </div>
        </div>
      </section>
