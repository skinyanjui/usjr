    ...
    <>
      ...
      <section className="bg-muted/30 py-12">
        <div className="container mx-auto max-w-4xl px-4">
          <h2 className="mb-2 text-center text-2xl font-bold">Helpful Guides for Evansville Residents</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            >
              ...
              <p className="text-muted-foreground text-xs">Expert local tips for efficient, cost-effective junk removal in Evansville.</p>
            </a>
            <a
            ...
            >
              ...
              <p className="text-muted-foreground text-xs">Full pricing breakdown for all services in Evansville and the Tri-State.</p>
            </a>
            <a
            ...
            >
              ...
              <p className="text-muted-foreground text-xs">Room-by-room checklist with eco-friendly tips for Evansville homeowners.</p>
            </a>
          </div>
        </div>
      </section>
