...
export function HeroQuoteForm() {
    ...
    return (
      <div className="border-border bg-card rounded-lg border p-6 text-center">
        <div className="bg-primary/10 mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full">
          <CheckCircle className="text-primary h-6 w-6" aria-hidden="true" />
        </div>
        <h3 className="text-foreground mb-2 text-lg font-semibold">Request Received!</h3>
  ...
  return (
    <div className="border-border bg-card rounded-lg border p-6">
      <h3 className="text-foreground mb-4 text-lg font-semibold">Get Your Free Quote</h3>
