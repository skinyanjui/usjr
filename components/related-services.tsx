      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {serviceLinks.length > 0 && (
            <div>
              <h3 className="mb-3 text-lg font-semibold text-gray-900">Explore Our Services</h3>
          ...
          {locationLinks.length > 0 && (
            <div>
              <h3 className="mb-3 text-lg font-semibold text-gray-900">Nearby Service Areas</h3>
              <ul className="list-disc space-y-1 pl-6 text-red-700">
                {locationLinks.map(l => (
                  <li key={l.href}>
