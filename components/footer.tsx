    ...
    <footer role="contentinfo" className="relative z-[2000] text-white">
      <div className="bg-blue-950">
        <div className="mx-auto max-w-7xl px-4 py-6">
          <div className="mb-6 rounded-lg bg-blue-800 p-4">
            <div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-center">
              ...
              <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
                <Button
                  asChild
                  className="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-4 py-2 text-sm font-semibold text-blue-900 shadow transition-colors hover:bg-blue-50 sm:px-5 dark:bg-gray-100 dark:text-blue-950 dark:hover:bg-blue-100"
                >
          ...
          <div className="mb-4 flex flex-wrap gap-4 text-white">
            ...
            <div className="w-1/2 sm:w-[calc(50%-0.5rem)] lg:w-[calc(20%-0.8rem)]">
              ...
              <div className="mb-2 flex items-center gap-2 text-xs text-blue-100 sm:text-sm">
            ...
            <div className="w-1/2 sm:w-[calc(50%-0.5rem)] lg:w-[calc(20%-0.8rem)]">
              ...
              <ul className="space-y-2 text-xs text-white sm:text-sm">
                <li>
                  <Link href="/about" className="text-white transition-colors hover:text-blue-200">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/blog" className="text-white transition-colors hover:text-blue-200">
                    Blog
                  </Link>
                </li>
                <li>
                  <Link href="/faq" className="text-white transition-colors hover:text-blue-200">
                    FAQ
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/quote" className="text-white transition-colors hover:text-blue-200">
                    Get Free Quote
                  </Link>
                </li>
                <li>
            ...
            <div className="w-1/2 sm:w-[calc(50%-0.5rem)] lg:w-[calc(20%-0.8rem)]">
              ...
              <ul className="space-y-2 text-xs text-white sm:text-sm">
                <li>
                  <a href="/rss.xml" className="text-white transition-colors hover:text-blue-200">
                    RSS 2.0
                  </a>
                </li>
                <li>
                  <a href="/atom.xml" className="text-white transition-colors hover:text-blue-200">
                    Atom 1.0
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/mrss.xml" className="text-white transition-colors hover:text-blue-200">
                    Media RSS
                  </a>
                </li>
                <li>
                  <a href="/feed.txt" className="text-white transition-colors hover:text-blue-200">
                    Text Feed
                  </a>
                </li>
              </ul>
            ...
            <div className="flex flex-wrap gap-3 text-xs sm:text-sm">
              <div className="flex w-1/2 items-center gap-2 sm:w-[calc(33.333%-0.75rem)]">
                ...
                <div>
                  ...
                  <div className="text-blue-100">Call or Text</div>
                </div>
              </div>
              <div className="flex w-1/2 items-center gap-2 sm:w-[calc(33.333%-0.75rem)]">
              ...
              <div className="flex w-1/2 items-center gap-2 sm:w-[calc(33.333%-0.75rem)]">
                ...
                <div className="text-blue-100">Evansville, Indiana & Southern Indiana</div>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-red-700/60 pt-3">
            <div className="flex flex-col items-center justify-between gap-1 text-xs text-white sm:text-sm md:flex-row">
              ...
              <div className="flex gap-4">
                <Link href="/privacy" className="text-white transition-colors hover:text-blue-200">
                  Privacy Policy
                </Link>
                <Link href="/terms" className="text-white transition-colors hover:text-blue-200">
                  Terms of Service
                </Link>
              </div>
            </div>
