    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 pt-32 pb-16">
        <div className="text-center text-white mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight">Uncle Sam Junk Removal</h1>
        ...
        <div className="text-center mb-16">
          <ThemedButton theme="red" className="px-12 py-4 rounded-full font-bold text-xl" asChild>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <GlassCard className="p-8 text-center hover:scale-105 transition-transform duration-300">
            <IconContainer icon={Truck} color="red" className="mx-auto mb-6" />
            ...
            <ThemedButton theme="red" fullWidth asChild>
              <Link href="/services/junk-removal">LEARN MORE</Link>
            </ThemedButton>
          </GlassCard>

          <GlassCard className="p-8 text-center hover:scale-105 transition-transform duration-300">
            <IconContainer icon={Container} color="red" className="mx-auto mb-6" />
            ...
            <ThemedButton theme="red" fullWidth asChild>
              <Link href="/services/dumpster-rental">LEARN MORE</Link>
            </ThemedButton>
          </GlassCard>

          <GlassCard className="p-8 text-center hover:scale-105 transition-transform duration-300">
            <IconContainer icon={Lightbulb} color="green" className="mx-auto mb-6" />
            ...
            <ThemedButton theme="green" fullWidth asChild>
              <Link href="/cleaning">LEARN MORE</Link>
            </ThemedButton>
          </GlassCard>
        </div>

        <GlassCard className="mt-16 p-8 max-w-2xl mx-auto">
          <h3 className="text-2xl font-bold mb-4">Ready to Get Started?</h3>
          <p className="text-lg mb-6 text-gray-200">
            Call now for your free estimate and same-day service in Evansville and surrounding areas!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <ThemedButton theme="red" className="px-8 py-3 rounded-full font-semibold text-lg" asChild>
