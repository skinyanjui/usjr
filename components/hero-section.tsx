				...
				<div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
					<GlassCard variant="white" className="p-6 md:p-8 text-center hover:scale-105 transition-transform duration-300">
						...
						<ThemedButton theme="red" fullWidth asChild>
							<Link href="/services/junk-removal" prefetch={false} aria-label="Learn more about Junk Removal">Learn more about Junk Removal</Link>
						</ThemedButton>
					</GlassCard>
					...
					<GlassCard variant="white" className="p-6 md:p-8 text-center hover:scale-105 transition-transform duration-300">
						...
						<ThemedButton theme="red" fullWidth asChild>
							<Link href="/services/dumpster-rental" prefetch={false} aria-label="Learn more about Dumpster Rental">Learn more about Dumpster Rental</Link>
						</ThemedButton>
					</GlassCard>
					...
					<GlassCard variant="white" className="p-6 md:p-8 text-center hover:scale-105 transition-transform duration-300">
						...
						<ThemedButton theme="green" fullWidth asChild>
							<Link href="/cleaning" prefetch={false} aria-label="Learn more about Cleaning Services">Learn more about Cleaning Services</Link>
						</ThemedButton>
					</GlassCard>
				</div>
				...
				<GlassCard variant="white" className="mt-16 p-6 md:p-8 max-w-2xl mx-auto">
					...
					<div className="flex flex-col sm:flex-row gap-4 justify-center">
						...
						<ThemedButton
							...
							asChild
						>
							<Link href="/quote" prefetch={false}>GET FREE QUOTE</Link>
						</ThemedButton>
					</div>
				</GlassCard>
			</div>
