        ...
        <CardContent className="py-12 text-center">
          ...
          <div className="space-y-4">
            <a
              ...
              className="inline-flex w-full max-w-sm items-center justify-center gap-2 rounded-lg bg-blue-900/35 px-5 py-2.5 font-semibold text-white ring-1 ring-white/30 transition-colors hover:bg-blue-900/45"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <Input
                ...
                required
                className={`mt-1 ${touched.fullName && fieldErrors.fullName ? 'border-red-500 focus-visible:ring-blue-800' : ''}`}
              ...
              {touched.fullName && fieldErrors.fullName && (
                <p id="fullName-error" className="mt-1 text-sm text-blue-800">
            ...
            <div>
              ...
              <Input
                ...
                required
                className={`mt-1 ${touched.phoneNumber && fieldErrors.phoneNumber ? 'border-red-500 focus-visible:ring-blue-800' : ''}`}
              ...
              {touched.phoneNumber && fieldErrors.phoneNumber && (
                <p id="phoneNumber-error" className="mt-1 text-sm text-blue-800">
          ...
          <div>
            ...
            <Input
              ...
              required
              className={`mt-1 ${touched.emailAddress && fieldErrors.emailAddress ? 'border-red-500 focus-visible:ring-blue-800' : ''}`}
            ...
            {touched.emailAddress && fieldErrors.emailAddress && (
              <p id="emailAddress-error" className="mt-1 text-sm text-blue-800">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              >
                <SelectTrigger
                  id="serviceNeeded"
                  className={`mt-1 ${touched.serviceNeeded && fieldErrors.serviceNeeded ? 'border-red-500 focus:ring-blue-800' : ''}`}
              ...
              {touched.serviceNeeded && fieldErrors.serviceNeeded && (
                <p id="serviceNeeded-error" className="mt-1 text-sm text-blue-800">
          ...
          <div className="space-y-4">
            ...
            <Button
              ...
              className="w-full bg-blue-800 py-3 text-lg font-semibold text-white hover:bg-blue-900 disabled:cursor-not-allowed disabled:opacity-70"
            >
