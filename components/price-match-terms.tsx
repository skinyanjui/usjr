      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Info className="w-4 h-4 text-red-600" /> Price Match Guarantee Terms
          </DialogTitle>
          <DialogDescription>
            We stand behind transparent, competitive pricing. If you find a lower written quote for the same service, we’ll match it.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 text-sm text-gray-700">
          <div>
            <h3 className="font-semibold text-gray-900 mb-1">What qualifies</h3>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-1">What doesn’t qualify</h3>
            <ul className="list-disc pl-5 space-y-1">
