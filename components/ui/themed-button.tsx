    ...
    const getThemeClasses = (theme: NonNullable<ThemedButtonProps['theme']>, variant: string) => {
      ...
      if (variant === 'outline') {
        const outlineMap = {
          ...
          orange:
            'border-orange-800 text-orange-800 hover:bg-orange-800 hover:text-white bg-transparent',
          green:
            'border-green-800 text-green-800 hover:bg-green-800 hover:text-white bg-transparent',
          blue: 'border-blue-800 text-blue-800 hover:bg-blue-800 hover:text-white bg-transparent',
          purple:
            'border-purple-800 text-purple-800 hover:bg-purple-800 hover:text-white bg-transparent',
