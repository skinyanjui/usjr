            ...
            return (
              <Link key={index} href={link.href}>
                <Button
                  variant="outline"
                  size="sm"
                  className={`${colors.button} bg-transparent group`}
                >
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <ArrowRight className="w-4 h-4 text-gray-400 group-hover:translate-x-1 transition-transform flex-shrink-0 mt-1" />
                        </div>
                        <p className="text-sm text-gray-600 mt-1">
                          {link.description}
                        </p>
                        {link.category && (
                          <Badge className={`${colors.badge} text-xs mt-2`}>
                            {link.category}
                          </Badge>
                        )}
                      </div>
