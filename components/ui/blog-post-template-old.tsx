...
export function BlogPostTemplate({ meta, children, relatedPosts }: BlogPostTemplateProps) {
  ...
  return (
    <article className="bg-background min-h-screen">
      {/* Hero Section */}
      <div className="bg-gray-900 text-white dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-4xl px-6 py-10 md:px-4 md:py-16">
        <div className="prose prose-lg dark:prose-invert prose-headings:font-bold prose-headings:tracking-tight prose-h2:mt-16 prose-h2:mb-6 prose-h2:text-3xl prose-h2:leading-tight prose-h2:scroll-mt-20 prose-h3:mt-10 prose-h3:mb-4 prose-h3:text-2xl prose-h3:leading-snug prose-h3:scroll-mt-20 prose-h4:mt-8 prose-h4:mb-3 prose-h4:text-xl prose-h4:scroll-mt-20 prose-p:mb-6 prose-p:leading-relaxed prose-p:text-base prose-a:font-medium prose-a:text-gray-900 dark:prose-a:text-gray-900 prose-a:no-underline prose-a:transition-colors hover:prose-a:underline hover:prose-a:text-gray-900 dark:hover:prose-a:text-gray-900 prose-strong:font-semibold prose-ul:my-6 prose-ul:list-disc prose-ul:pl-6 prose-ol:my-6 prose-ol:list-decimal prose-ol:pl-6 prose-li:my-2 prose-li:pl-2 prose-li:leading-relaxed prose-blockquote:border-l-4 prose-blockquote:border-gray-300 prose-blockquote:bg-gray-900 dark:prose-blockquote:bg-gray-900/30 prose-blockquote:py-4 prose-blockquote:px-6 prose-blockquote:my-8 prose-blockquote:not-italic prose-code:rounded prose-code:bg-gray-100 dark:prose-code:bg-gray-800 prose-code:px-1.5 prose-code:py-0.5 prose-code:text-sm prose-code:font-mono prose-code:before:content-[''] prose-code:after:content-[''] prose-pre:bg-gray-900 dark:prose-pre:bg-gray-950 prose-pre:text-gray-100 prose-img:rounded-lg prose-img:shadow-lg prose-img:my-8 mx-auto max-w-3xl">
          <style jsx global>{`
        ...
        {/* CTA Section */}
        <div className="mt-12 rounded-2xl bg-gray-900 p-8 md:p-10 dark:bg-gray-900/30">
          ...
          <div className="flex flex-wrap gap-3">
            <Button
              asChild
              className="bg-gray-900 px-6 py-2.5 text-base font-semibold text-white hover:bg-gray-900"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="border-2 border-gray-300 bg-transparent px-6 py-2.5 text-base font-semibold text-gray-900 hover:bg-gray-900 hover:text-white"
            >
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {relatedPosts.map(post => (
                <Link
                  key={post.href}
                  href={post.href}
                  className="group border-border bg-card rounded-xl border p-6 shadow-sm transition-all hover:border-gray-300 hover:shadow-md dark:hover:border-gray-300"
                >
                  <div className="mb-2">
                    <span className="text-xs font-semibold tracking-wide text-gray-900 uppercase dark:text-gray-900">
                      {post.category}
                    </span>
                  </div>
                  <h3 className="text-foreground mb-2 text-lg font-bold group-hover:text-gray-900 dark:group-hover:text-gray-900">
                    {post.title}
                  </h3>
