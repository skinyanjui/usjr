...
export function BlogPostTemplate({ meta, children, relatedPosts }: BlogPostTemplateProps) {
  ...
  return (
    <article className="bg-background min-h-screen">
      {/* Hero Section */}
      <div className="bg-red-700 text-white dark:bg-red-900">
      ...
      <div className="mx-auto max-w-4xl px-6 py-10 md:px-4 md:py-16">
        ...
        {/* CTA Section */}
        <div className="mt-12 rounded-2xl bg-red-50 p-8 md:p-10 dark:bg-red-950/30">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {relatedPosts.map(post => (
                <Link
                  key={post.href}
                  href={post.href}
                  className="group border-border bg-card rounded-xl border p-6 shadow-sm transition-all hover:border-red-600 hover:shadow-md dark:hover:border-red-400"
                >
                  <div className="mb-2">
                  ...
                  <h3 className="text-foreground mb-2 text-lg font-bold group-hover:text-red-600 dark:group-hover:text-red-400">
                    {post.title}
                  </h3>
