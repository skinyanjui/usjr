...
describe('StructuredData Component', () => {
  beforeEach(() => {
    (getAggregateTestimonialStats as jest.Mock).mockReturnValue({ averageRating: 5, reviewCount: 10 });
  })
  ...
  it('correctly calculates price range for LocalBusiness', () => {
    ...
    (getActiveServices as jest.Mock).mockReturnValue([
      ...
      { name: 'Service C', price: 'From $200 to $500', description: 'Desc C', category: 'residential' },
